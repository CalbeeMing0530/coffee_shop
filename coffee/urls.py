...
urlpatterns = [
    ...
    url(r'^dispatch_coupon_to_users/$', views.dispatch_coupon_to_users),
    url(r'^dispatch_coupon_operation/(?P<coupon_price>.+)$', views.dispatch_coupon_operation),
    ...
    url(r'^coupon_detail/(?P<coupon_user>.+)$', views.coupon_detail),
]
